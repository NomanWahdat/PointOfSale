        ...
        <Row>
            ...
            <div className="d-flex">
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  />
                  <Form.Check.Label className="mb-0">
                    <strong>Full or Partial Refund,</strong> If the
                    product is not as described in details
                  </Form.Check.Label>
                </Form.Check>
          ...
          >
            ...
            <div className="fs-2 fw-semi-bold">
              All Total:{" "}
              <span className="text-primary">${payableTotal}</span>
            </div>
            <Button
              variant="success"
              className="mt-3 px-5"
            ...
            <p className="fs--1 mt-3 mb-0">
              By clicking <strong>Confirm &amp; Pay </strong> button
              you agree to the{" "}
...
PaymentMethod.propTypes = {
  payableTotal: PropTypes.oneOfType([
    PropTypes.number,
    PropTypes.string
  ])
};

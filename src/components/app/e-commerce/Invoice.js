    ...
    <>
      ...
      <Card className="mb-3">
          ...
          <Row className="align-items-center text-center mb-3">
            ...
            <Col className="text-sm-end mt-3 mt-sm-0">
              ...
              <p className="fs--1 mb-0">
                156 University Ave, Toronto <br /> On, Canada, M5H
                2H7
              </p>
            </Col>
            <Col xs={12}>
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="align-middle">
                      ...
                      <p className="mb-0">
                        Includes basic wireframes and responsive
                        templates
                      </p>
                    </td>
        ...
        <Card.Footer className="bg-light">
          <p className="fs--1 mb-0">
            <strong>Notes: </strong> We really appreciate your
            business and if there’s anything else we can do, please
            let us know!
          </p>
        </Card.Footer>
      </Card>
